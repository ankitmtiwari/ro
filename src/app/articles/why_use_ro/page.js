...
const Why_use_ro = () => {
  const img ="https://res.cloudinary.com/da5scjnwh/image/upload/v1697363666/RO-IMAGES/ftfg5iljeohhw5qeaajc.webp";
      ...
      <html>
        ...
        <body>
          ...
          <div className="flex justify-center p-1 rounded-md sm:p-3 ">
            <img className="rounded-md w-full h-full sm:w-fit sm:h-fit" src={img} alt="" />
          </div>

const products = {
  1: {
    ...
    details: {
      ...
      "Large Storage Capacity":
        "KENT Ace features a large tank that can store up to 8 litres of water. This water purifier has been designed to deliver a purification capacity of 20 L/hr. This means you won’t have to wait to enjoy pure water that tastes good.",
  ...
  8: {
    ...
    details: {
      ...
      "UV LED Purification":
        "A UV LED is fitted in this water purifier’s tank to kill bacteria and purify the water.",

      "Purification Storage Capacity":
        "Boasting a high purification capacity of up to 20 L/hr and a large storage capacity of 8 L, this appliance provides ample purified water for your family even when there’s no power. Furthermore, a water level indicator lets you see the purified water level in the tank.",
  ...
  22: {
    title:
      "Aquaguard Aura 7 L RO + UV + UF + MTDS Water Purifier Active Copper technology (Black)",
    required_desc: {
      Brand: "Aquaguard",
      "Model Name": "Aura",
      Color: "Black",
      "Total Capacity": "7 L",
      "Purifying Technology": "RO + UV + UF + MTDS",
    },
    details: {},
    desc: {
      "Model Name": "Aura",
      ...
      "Total Capacity": "7 L",
      "Purifying Technology": "RO + UV + UF + MTDS",
      "In The Box": "1 Water Purifier, Adapter with Bracket, User Manual",
      "Power Requirement": "150 - 250 V AC, 50 Hz",
      ...
      "Child Lock": "No",
      "Filter Life": "6000 L",
      "Membrane Type": "RO, UV, UF",
      "Storage Tank Material": "ABS",
      "Other Convenience Features":
        "Compact, Energy Saving Mode, Dispenses Water Without Electricity",
      "Filtration Capacity": "15 L/hr",
      "Purification Capacity": "6000 L",
      "Maximum Input Water Temperature": "40 DegreeC",
      "Minimum Input Water Temperature": "10 DegreeC",
      "Installation Type": "Wall Mountable, Counter Top",
      "Purification Stages": "8",
      "Total Dissolved Solids (TDS) Levels": "200 ppm",
    },
    display_Image: "/products/prod22_1.webp",
    images: [
      "/products/prod22_2.webp",
      "/products/prod22_3.webp",
      "/products/prod22_4.webp",
      "/products/prod22_5.webp",
      "/products/prod22_6.webp",
    ],
  },
  23: {
    title:
      "Aquaguard Glory 6 L RO + UV + MTDS + Alkaline Water Purifier with Taste Adjuster (Black)",
    required_desc: {
      Brand: "Aquaguard",
      "Model Name": "Glory",
      Color: "Black",
      "Total Capacity": "6 L",
      "Purifying Technology": "RO + UV + MTDS + Alkaline",
    },
    details: {},
    desc: {
      "Model Name": "Glory",
      ...
      "Purifying Technology": "RO + UV + MTDS + Alkaline",
      "In The Box":
        "1 Water Purifier, Plumbing kit, Power Supply Adapter and Bracket for Adapter",
      ...
      "Overflow Protection": "Yes",
      "Filter Type":
        "pre filter, CARBON FILTER, SEDIMENT FILTER, MEMBRANE, UF FILTER, UV LAMP, MINERAL CARTRIDGE",
      "Storage Tank Material": "Plastic",
      "Other Body Features": "Tough, Durable, Anti-corrosive and SS 304 Grade",
      Alarms: "Yes",
      "Filtration Capacity": "15 L/hr",
      "Hot Water Dispenser": "No",
      "Maximum Input Water Temperature": "40 Degrees Celsius",
      "Minimum Input Water Temperature": "10 Degrees Celsius",
      "Installation Type": "Wall Mount and Table Top",
      "Purification Stages": "7",
      "Total Dissolved Solids (TDS) Levels": "2000 ppm",
    },
    display_Image: "/products/prod23_1.webp",
    images: [
      "/products/prod23_2.webp",
      "/products/prod23_3.webp",
      "/products/prod23_4.webp",
      "/products/prod23_5.webp",
    ],
  },
  24: {
    title:
      "Aquaguard Glory 6 L RO + UV + MTDS Water Purifier with Active Copper technology (Black, Gold)#JustHere",
    required_desc: {
      Brand: "Aquaguard",
      "Model Name": "Glory",
      Series: "",
      Color: "Black, Gold",
      "Total Capacity": "6 L",
      "Purifying Technology": "RO + UV + MTDS",
    },
    details: {
      "Other Convenience Features":
        "The Smart Service App Notifies You When Service Is Due and You Can Book a Service Request in Just Few Seconds",
      "Other Features":
        "Taste Adjuster: Always Provides Sweet Tasting Water Irrespective of the Water Source, RO Technology Removes TDS, Hardness, Pesticides and Heavy Metals. Eliminates Harmful Bacteria, Viruses, Protozoa and Cysts",
    },
    desc: {
      "Model Name": "Glory",
      Color: "Black, Gold",
      "Total Capacity": "6 L",
      "Purifying Technology": "RO + UV + MTDS",
      "In The Box": "1 Water Purifier, Installation Kit, User Manual",
      "Power Requirement": "AC 230 V, 50 Hz",
      ...
      "Filter Life": "6000 L",
      "Filter Type":
        "I-Filter, Chemi-Block, Membrane Life Enhancer, RO Membrane, UV, Taste Adjuster, Active Copper",
      "Membrane Type": "RO, UV",
      "Storage Tank Material": "Plastic",
      Indicators:
        "LED Indication Alerts When Tank Is Full, When Service Is Due and When Cartridges Need Replacement",
      "Other Body Features": "tank with water level indicator",
      "Filtration Capacity": "15 L/hr",
      "Hot Water Dispenser": "No",
      "Maximum Input Water Temperature": "10 DegreeC",
      "Minimum Input Water Temperature": "40 DegreeC",
      "Installation Type": "Wall Mount and Table Top",
      "Purification Stages": "7 Stages of Purification",
      "Total Dissolved Solids (TDS) Levels": "2000 ppm",
      "Water Flow Rate": "RO - 0.2-.25 l/min, UV- 0.55-0.65 l/min",
    },
    display_Image: "/products/prod24_1.webp",
    images: [
      "/products/prod24_2.webp",
      "/products/prod24_3.webp",
      "/products/prod24_4.webp",
      "/products/prod24_5.webp",
      "/products/prod24_6.webp",
    ],
  },
  25: {
    title:
    ...
    required_desc: {
      ...
      Series: "",
      Color: "Black",
      "Total Capacity": "5.5 L",
      "Purifying Technology": "RO + UV + MTDS + SS",
    },
    details: {},
    desc: {
      "Model Name": "Ritz",
      ...
      "Total Capacity": "5.5 L",
      "Purifying Technology": "RO + UV + MTDS + SS",
      "In The Box": "1 Water Purifier, Plumbing kit, Accessories",
      ...
      "Filter Life": "6000 L",
      "Filter Type":
        "I-Filter, Chemi Block, Membrane Life Enhancer, RO Cartridge, UV e-boiling, Post Carbon, Taste Adjuster, Active Copper with Zinc",
      "Storage Tank Material": "Food Grade Plastic",
      Alarms: "No",
      "Purification Capacity": "6000 L",
      "Cold Water Dispenser": "No",
    ...
    display_Image: "/products/prod25_1.webp",
    images: [
      "/products/prod25_2.webp",
      "/products/prod25_3.webp",
      "/products/prod25_4.webp",
      "/products/prod25_5.webp",

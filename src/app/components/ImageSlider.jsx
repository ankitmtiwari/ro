...
function ImageSlider() {
  ...
  return (
    <div className='max-w-[1920px] h-[350px] lg:h-[700px] w-full m-auto py-16 px-4 sm:relative group'>
      ...
      ></div>
      {/* Left Arrow */}
      <div className='hidden group-hover:block absolute top-[50%] -translate-x-0 translate-y-[-200%] sm:translate-y-[-50%] left-5 text-sm lg:text-2xl rounded-full p-1 lg:p-2 bg-black/20 text-white cursor-pointer'>
        <BsChevronCompactLeft onClick={prevSlide}  className='h-5 w-5 lg:h-7 lg:w-7'/>
      </div>
      {/* Right Arrow */}
      <div className='hidden group-hover:block absolute top-[50%] -translate-x-0 translate-y-[-200%] sm:translate-y-[-50%] right-5 text-sm lg:text-2xl rounded-full p-1 lg:p-2 bg-black/20 text-white cursor-pointer'>

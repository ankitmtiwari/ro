...
import { AiOutlineTwitter, AiOutlineClose, AiOutlineWhatsApp } from "react-icons/ai";
        ...
        <div className=" sm:mx-36 pt-4">
          <div className="flex flex-col sm:flex-row items-center sm:justify-between">
            ...
            <div className="flex gap-4 pb-1 sm:p-0">
              ...
              <BiLogoFacebook size={20} className="nvicon border p-2 h-6 w-6 rounded-full border-white" />
              <AiOutlineTwitter size={20} className="nvicon border p-2 h-6 w-6 rounded-full border-white" />
              <TfiYoutube size={20} className=" nvicon border p-2 h-6 w-6 rounded-full border-white" />
            </div>
          </div>
        </div>
